...
def cvloop(run_event):
    ...
    while run_event.is_set(): #while the thread is active we loop
		...
		'''
		cv2.line(image, (tuple(points[48].ravel())), (tuple(points[49].ravel())), (0, 0, 0),3)
		cv2.line(image, (tuple(points[49].ravel())), (tuple(points[50].ravel())), (0, 0, 0), 3)  
		cv2.line(image, (tuple(points[50].ravel())), (tuple(points[51].ravel())), (0, 0, 0), 3)  
		cv2.line(image, (tuple(points[59].ravel())), (tuple(points[48].ravel())), (0, 0, 0), 3)
		'''
